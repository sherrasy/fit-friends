import { createNewUser,setUserData, userData } from '@store/user-data/user-data';
...
import { checkAuth, checkEmail, fetchCurrentUser, fetchReadyUserList, fetchUser, fetchUserList, fetchUserListAmount, login, updateUser } from '@store/user-data/api-actions';
