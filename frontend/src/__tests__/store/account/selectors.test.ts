...
import { getCertificates, getCoachOrders, getFriendChanging, getFriends, getFriendsLoadingStatus, getFriendsPages, getNotificationDeleting, getNotifications, getNotificationsError, getNotificationsLoading, getOrders, getOrdersLoadingStatus, getOrdersPages } from '@store/account-data/selectors';
