...
import { CaloriesAmount, DescriptionLength, RaitingCount, ReviewTextLength } from './validation.constant';
...
import { DefaultParam } from './constant';
  ...
  return (
   {
     ...
     sportsmanInfo: {
       ...
       caloriesTotal: datatype.number({min:CaloriesAmount.Min, max:CaloriesAmount.Max}),
       caloriesPerDay:  datatype.number({min:CaloriesAmount.Min, max:CaloriesAmount.Max}),
...
export const makeFakeWorkout = ():Workout=>{
  ...
  return ({
    ...
    workoutTime: random.arrayElement(workoutTimes),
    price,
    calories: datatype.number({min:CaloriesAmount.Min, max:CaloriesAmount.Max}),
    description: lorem.words(DescriptionLength.Min),
    sex: random.arrayElement(genders),
    video: datatype.uuid(),
