        ...
        <div className="intro">
          <div className="intro__background">
            <picture>
              ...
              />
              <img
                src="img/content/sitemap//background.jpg" srcSet="img/content/sitemap//background@2x.jpg 2x" width="1440"
                height="1024" alt="Фон с бегущей девушкой"
              />
            </picture>
          </div>
          <div className="intro__wrapper">
            ...
            <div className="intro__title-logo">
              <picture>
                ...
                />
                <img
                  src="img/content/sitemap//title-logo.png" srcSet="img/content/sitemap//title-logo@2x.png 2x" width="934"
                  height="455" alt="Логотип Fit Friends"
                />
              </picture>
            </div>
            <div className="intro__buttons">
              <Link to={AppRoute.Register} className="btn intro__button" type="button">Регистрация</Link>
